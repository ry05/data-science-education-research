...
```{r, message=FALSE}
df <- read_csv("../../data_collection/data/labelled/masters_data_programs_india_usa.csv")
df <- df %>%
  rename(
...
p1 <- ggviolin(df, x = "country", y = "D1",
  ...
  stat_pvalue_manual(test_means, tip.length=0.01) + 
...
```{r, message=FALSE, echo=FALSE, fig.width = 15, fig.height = 24}

ggdotchart(df, x = "id", y = "gds_score",
           color = "country",                               
